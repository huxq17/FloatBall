...
public class FloatBallMenu implements IMenu {
    ...
    @Override
    public void addLeftMenu(RelativeLayout parent, RelativeLayout.LayoutParams layoutParams) {
        layoutParams.setMargins(0, 0, DensityUtil.dip2px(parent.getContext(), 20), 0);
        ...
        layoutParams = new RelativeLayout.LayoutParams(DensityUtil.dip2px(parent.getContext(), 1), DensityUtil.dip2px(parent.getContext(), 30));
        layoutParams.setMargins(0, DensityUtil.dip2px(parent.getContext(), 8), 0, DensityUtil.dip2px(parent.getContext(), 8));
        layoutParams.addRule(RelativeLayout.LEFT_OF, tvLeftGift.getId());
        ...
        layoutParams = new RelativeLayout.LayoutParams(DensityUtil.dip2px(parent.getContext(), 52), DensityUtil.dip2px(parent.getContext(), 30));
        layoutParams.addRule(RelativeLayout.LEFT_OF, verticalLine.getId());
    ...
    @Override
    public void addRightMenu(RelativeLayout parent, RelativeLayout.LayoutParams layoutParams) {
        layoutParams.setMargins(DensityUtil.dip2px(parent.getContext(), 20), 0, 0, 0);
        ...
        layoutParams = new RelativeLayout.LayoutParams(DensityUtil.dip2px(parent.getContext(), 1), DensityUtil.dip2px(parent.getContext(), 30));
        layoutParams.setMargins(0, DensityUtil.dip2px(parent.getContext(), 8), 0, DensityUtil.dip2px(parent.getContext(), 8));
        layoutParams.addRule(RelativeLayout.RIGHT_OF, tvLeftCenter.getId());
        View verticalLine = new View(parent.getContext());
        verticalLine.setId(getId());
        verticalLine.setBackgroundColor(Color.parseColor("#e5e5e5"));
        parent.addView(verticalLine, layoutParams);
        ...
        layoutParams = new RelativeLayout.LayoutParams(DensityUtil.dip2px(parent.getContext(), 52), DensityUtil.dip2px(parent.getContext(), 30));
        layoutParams.addRule(RelativeLayout.RIGHT_OF, verticalLine.getId());
